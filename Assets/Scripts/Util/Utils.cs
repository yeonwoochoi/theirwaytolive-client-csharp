...
namespace Util
{
    public static class UtilsClass {
        ...
        public static GameObject CreateWorldSprite(string name, Sprite sprite, Vector3 position, Vector3 localScale, int sortingOrder, Color color) {
            return CreateWorldSprite(null, name, sprite, position, localScale, LayerType.Layer3, sortingOrder, color);
        }
        
        // Create a Sprite in the World
        public static GameObject CreateWorldSprite(Transform parent, string name, Sprite sprite, Vector3 localPosition, Vector3 localScale, LayerType layerType, int sortingOrder, Color color) {
            ...
            spriteRenderer.sortingLayerName = layerType.LayerTypeToString();
        ...
        */
        ...
        /// <returns></returns>
        public static bool GetRandomBooleanValueByPercentage(int percentage)
        {
