...
namespace Manager
{
    public class GameManager : MonoSingleton<GameManager>
    {
        ...
        private void Start()
        {
            ...
            Enemy.Create(new Vector3(6, 19, 0), GameAssets.i.pfEnemy1, WeaponType.Spear, EnemyActionType.Escape, new List<HeroControlType>
                {
                    HeroControlType.Joystick
                }, true); 
            Enemy.Create(new Vector3(6, 16, 0), GameAssets.i.pfEnemy1, WeaponType.Arrow, EnemyActionType.Escape, new List<HeroControlType>
                {
                    HeroControlType.Joystick
                }, true); 
            Enemy.Create(new Vector3(6, 13, 0), GameAssets.i.pfEnemy1, WeaponType.Sword, EnemyActionType.Escape, new List<HeroControlType>
                {
                    HeroControlType.Joystick
                }, true);
            /*
